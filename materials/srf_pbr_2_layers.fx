            ...
            inout s_shader_data shader_data)
{
	...
	
    {
		...
		base_normal.xy = lerp(base_normal.xy, layer_1_base_normal.xy + base_normal.xy, shader_data.layer_masks.r);
			...
			base_normal.xy = lerp(base_normal.xy, layer_2_base_normal.xy + base_normal.xy, shader_data.layer_masks.g);
		#endif
