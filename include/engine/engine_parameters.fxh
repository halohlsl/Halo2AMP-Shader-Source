...
CBUFFER_BEGIN(EngineMaterialVS)
	CBUFFER_CONST_ARRAY(EngineMaterialVS,		float4,		vs_material_generic_parameters, [4],	eMPSR_firstMaterialVSGenericRegister)
CBUFFER_END
...
PIXEL_TEXTURE(_2D,	ps_view_albedo,			_ps_view_albedo,		16)
PIXEL_TEXTURE(_2D,	ps_view_normal,			_ps_view_normal,		17)
PIXEL_TEXTURE(_2D,	ps_view_shadow_mask,	_ps_view_shadow_mask,	18)
PIXEL_TEXTURE_USING_SAMPLER(_2D_ARRAY,	ps_bsp_lightprobe_dir_and_bandwidth,		_ps_bsp_lightprobe_dir_and_bandwidth,		19,		ps_bsp_bilinear_sampler)
PIXEL_TEXTURE_USING_SAMPLER(_2D_ARRAY,	ps_bsp_lightprobe_hdr_color,				_ps_bsp_lightprobe_hdr_color,				20,		ps_bsp_bilinear_sampler)
PIXEL_TEXTURE_USING_SAMPLER(_2D,		ps_lightmap_sharpen_falloff,				_ps_lightmap_sharpen_falloff,				21,		ps_bsp_bilinear_sampler)
PIXEL_TEXTURE_USING_SAMPLER(_2D,		ps_bsp_lightprobe_analytic,					_ps_bsp_lightprobe_analytic,				22,		ps_bsp_bilinear_sampler)
PIXEL_TEXTURE_USING_SAMPLER(_2D,		ps_bsp_lightprobe_hybrid_overlay_macro,		_ps_bsp_lightprobe_hybrid_overlay_macro,	23,		ps_bsp_point_sampler)
PIXEL_TEXTURE_USING_SAMPLER(_2D,		ps_bsp_lightprobe_hybrid_overlay_micro,		_ps_bsp_lightprobe_hybrid_overlay_micro,	24,		ps_bsp_point_sampler)
PIXEL_TEXTURE_USING_SAMPLER(_2D,		ps_bsp_lightprobe_hybrid_refinement,		_ps_bsp_lightprobe_hybrid_refinement,		25,		ps_bsp_bilinear_sampler)
