...
#else
		color = sample3DLOD(ps_color_grading_0, color.rgb, 0);
#endif		
	}
...
#else
					colorGradingSample = sample3DLOD(ps_color_grading_0, colorGradingSample.rgb, 0);
#endif
				}
				else
				{
...
#else
					colorGradingSample = sample3DLOD(ps_color_grading_1, colorGradingSample.rgb, 0);
#endif
				}
